...
<div class="container">
    ...
    @if($detail->type =='edit_user' || $detail->type == 'add_user')
        <div class="row">
        ...
        <div class="row">
            <div class="col-md-1">
                <button type="approve" class="btn btn-primary" style="background:green" onclick="event.preventDefault();document.getElementById('user-approve').submit();">Approve</button>   
            </div>
            <div class="col-md-2">
                <button type="reject" class="btn btn-primary" style="background:red" onclick="event.preventDefault();document.getElementById('user-reject').submit();">Reject</button>
            </div>
